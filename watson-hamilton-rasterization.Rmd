...
```{r}
watson2000.2004_ind <- read_csv("CatchInd2000_2004.csv") #read_csv(paste0(path,"CatchInd2000_2004.csv")) # Watson 2000-2004 industrial catch numbers
cell_codes <- read_csv("Watson_CellCodes.csv") #read_csv(paste0(path,"Watson_CellCodes.csv")) # lat long for the center of each cell and which cell number it refers to
...
# Tell R it is a gridded patter if using Raster()
#gridded(joined_ind_2000_2004) <- TRUE
...
raster_ind_2000_2004 <- rasterize(joined_ind_2000_2004, r, joined_ind_2000_2004$IUU)
